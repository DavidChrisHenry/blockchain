   ...
   <div class="col-75">
    <div class="container">
     <form action="/action_page.php">
      ...
      <div class="col-25">
       <div class="container">
        <h3>Giỏ hàng <span class="price" style="color:rgb(250, 250, 250)"><i class="fa fa-shopping-cart"></i></span>
         </h4>
         <hr>
          ...
          <div class="cart-items">
           <div class="cart-row">
            <div class="cart-item cart-column">
             ...
             <span class="cart-item-title">SCOTTISH FOLD</span>
            </div>
            <span class="cart-price cart-column">12.000.000đ</span>
           ...
           <div class="cart-row">
            ...
            <span class="cart-price cart-column">1.800.000đ</span>
            <div class="cart-quantity cart-column">
             <input class="cart-quantity-input" type="number" value="1">
             <button class="btn btn-danger" type="button">Xóa</button>
            </div>
           ...
           <div class="cart-row">
            ...
            <span class="cart-price cart-column">13.500.000đ</span>
            <div class="cart-quantity cart-column">
             <input class="cart-quantity-input" type="number" value="1">
             <button class="btn btn-danger" type="button">Xóa</button>
            </div>
           ...
           <div class="cart-row">
            <div class="cart-item cart-column">
             ...
             <span class="cart-item-title">Balo phi hành gia</span>
            </div>
            <span class="cart-price cart-column">350.000đ</span>
            <div class="cart-quantity cart-column">
             <input class="cart-quantity-input" type="number" value="1">
             <button class="btn btn-danger" type="button">Xóa</button>
            </div>
           ...
           <div class="cart-total">
            ...
            <span class="cart-total-price">27.800.000 VNĐ</span>
           </div>
          </div>
         </div>
       </div>
