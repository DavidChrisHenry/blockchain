...
<body>
 ...
 <section class="section" id="dog-title-picture">
  <div class="row row-full-width">
   <div class="col medium-6">
    <div id="imagecorgi">
     <a class="" target="_blank" rel="noopener noreferrer">
      <img width="1920" height="721" src="./img/wallpaper/corgi.jpg" title="Chó Corgi"
   ...
   <div class="col medium-6">
    <div id="imagephocsoc">
     <a class="">
      <img width="1920" height="721" src="./img/wallpaper/phocsoc.jpg" title="Chó phốc sóc"
   ...
   <div id="col" class="col medium-4">
    <div id="imagepoodle">
     <a class="" target="_blank" rel="noopener noreferrer">
      <img width="1920" height="721" src="./img/wallpaper/poodle.jpg" title="Chó Poodle"
   ...
   <div id="col" class="col medium-4">
    <div id="imagebull">
     <a class="">
      <img width="1920" height="721" src="./img/wallpaper/bull.png" title="Chó Bull"
   ...
   <div id="col" class="col medium-4 small-6 large-4">
    <div id="imagechowchow">
     <a class="">
      <img width="1920" height="721" src="./img/wallpaper/chowchow.jpg" title="Chó Chow Chow"
 ...
 <section id="dog">
  ...
  <div class="section-dog-cat">
   <div class="picture">
    <a href="./Alaska.php">
     <img src="./img/dog/alaska.png" alt="alaska">
    </a>
  ...
  <div class="section-dog-cat">
   <div class="picture">
    <a href="./Golden.php">
     <img src="./img/dog/golden.png" alt="Golden">
    </a>
  ...
  <div class="section-dog-cat">
   <div class="picture">
    <a href="./husky.php">
     <img src="./img/dog/husky.png" alt="Husky">
    </a>
 ...
 <section id="cat">
  <div class="section-dog-cat">
   <div class="picture">
    <a href="./Meolongngan.php">
     <img src="./img/cat/meo-anh-long-ngan.png" alt="meoanhlongngan">
    </a>
  ...
  <div class="section-dog-cat">
   <div class="picture">
    <a href="./maincoon.php">
     <img src="./img/cat/maincoon.png" alt="maincoon">
    </a>
  ...
  <div class="section-dog-cat">
   <div class="picture">
    <a href="./giohang.php">
     <img src="./img/cat/Scottish-gold.png" alt="Scottishgold">
    </a>
  ...
  <div class="section-dog-cat">
   <div class="picture">
    <a href="./giohang.php">
     <img src="./img/cat/meo-ba-tu.png" alt="meobatu">
    </a>
